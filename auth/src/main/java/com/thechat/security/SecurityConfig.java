...
import com.thechat.auth.CredentialRepository;

@Configuration
public class SecurityConfig {

    @Bean
    SecurityFilterChain securityFilterChain(HttpSecurity http, CookieBearerTokenResolver cookieBearerTokenResolver)
            throws Exception {
        return http
    ...
    @Bean
    UserDetailsService userDetailsService(CredentialRepository credentialRepository) {
        return email -> credentialRepository.findByEmail(email)
                .map(cred -> User.withUsername(cred.getEmail())
